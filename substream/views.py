    ...
    for stream_index, language in subtitle_streams:
        ...
        if subtitle_path and os.path.exists(subtitle_path):
            ...
            if vtt_path and os.path.exists(vtt_path):
                ...
                # TODO remove SRT file after conversion
...
def probe_subtitles(video_path):
    ...
    probe_command = [
        ffprobe_path,
        '-v', 'error',
        '-select_streams', 's',  # TODO Select subtitle streams
...
def view_video(request, id):
    ...
    if form.is_valid():
        ...
        # TODO Search through the subtitle files
        for subtitle in subtitles:
            subtitle_path = os.path.join(settings.MEDIA_ROOT, str(subtitle.subtitle_file))
            print(f"Searching in: {subtitle_path}")  # TODO Debugging line

            search_results += search_subtitles(subtitle_path, query, subtitle.language)
        print(f"Search Results: {search_results}")  # TODO Debugging line
    ...
    # TODO For regular page requests, return the full page context
    context = {
        'video': video,
        'subtitles': subtitles,
        'form': form,
